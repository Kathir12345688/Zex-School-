      ...
      <main className="container login-shell__inner">
        <section className="login-card" aria-label="Admin login form">
          ...
          <div className="login-card__heading">
            ...
            <h2>Admin Login</h2>
            <p className="login-card__subtitle">Sign in to access the Zex School Management Dashboard.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="login-form">
            <div className="form-group login-field">
              ...
              <div className="login-input-wrap">
                ...
                <input id="username" placeholder="Enter your username" value={form.username} onChange={(event) => setForm({ ...form, username: event.target.value })} required />
              </div>
            </div>
            <div className="form-group login-field">
              ...
              <div className="login-input-wrap">
                ...
                <input id="password" type="password" placeholder="Enter your password" value={form.password} onChange={(event) => setForm({ ...form, password: event.target.value })} required />
              </div>
            </div>
            ...
            <div className={`login-error ${error ? 'is-visible' : ''}`} aria-live="polite">{error}</div>
          </form>
        </section>
      </main>
    </div>
